...
export function materialDeCasting(): string {
  ...
  return (
    ...
    `"Alaia" salió como "Alalia", "Gael" como "Gale", "Ariel" salió partido y "Genaro" como "Ginaro" , "Fabricio" como "Fabrigio", "Kiara" como "Callara" e "Itzel" como "Edsel" — todos fuera de la lista por eso. Un personaje cuyo nombre suena distinto cada vez que ` +
