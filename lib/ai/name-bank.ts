...
export function materialDeCasting(): string {
  ...
  return (
    ...
    `"Alaia" salió como "Alalia", "Gael" como "Gale" y "Ariel" salió partido — los tres fuera de la lista por eso. Un personaje cuyo nombre suena distinto cada vez que ` +
