...
const M_JOVEN = "Thiago Benjamín Matías Santiago Emiliano Bastián Joaquín Facundo Bautista Lautaro Valentín Tomás Franco Agustín Ignacio Vicente Cristóbal Maximiliano Alonso Damián Alexis Ángel Uriel Leonel Emmanuel Josué Isaac Dante Ariel Nicolás Rodrigo Sebastián Martín Lucas Bruno Simón Aaron Adrián Eduardo Hugo Emilio Joaquín Ramiro Julián Lorenzo Federico Andrés Esteban Gonzalo Ignacio Marcos Pablo Ariel Fabricio Nahuel Franco Ezequiel Mauro Braulio Cristóbal Renato Alonso Tadeo Elías Samuel Rafael Óscar Antonio Guillermo".split(" ");
...
export function materialDeCasting(): string {
  ...
  return (
    ...
    `"Alaia" salió como "Alalia" y "Gael" como "Gale". Un personaje cuyo nombre suena distinto cada vez que ` +
