...
- ⚠️ DOS PERSONAJES DEL MISMO GÉNERO = FÍSICAMENTE OPUESTOS, SIEMPRE. Si el elenco tiene dos mujeres (o dos hombres) — hermanas, amigas, madre e hija, esposa y amante — sus rasgos se diseñan para distinguirse en un vistazo de 2 segundos: pelo de COLOR y LARGO distintos (una negra lacia larga, la otra castaña ondulada corta), paleta de ropa distinta, y si la premisa lo permite, edad o complexión distinta. Escribilo EXPLÍCITO en la descripción de cada una ("cabello castaño claro ondulado hasta los hombros — NUNCA negro ni lacio, para no confundirse con su hermana"). Medido en un video terminado: esposa y hermana-amante salieron idénticas (pelo negro largo las dos) y el beso de la traición terminó siendo el esposo besando A SU PROPIA ESPOSA — la historia entera se rompió.
- ⚠️ PREMISA DE UN SOLO SUJETO = UN PERSONAJE, EN CUALQUIER FORMATO. Si la premisa describe a UNA persona viviendo algo ("mujer que se convierte en víbora y lo disfruta", "hombre que colecciona…") y NO nombra a nadie más, el elenco es ESA persona y nadie más. El "testigo que descubre" NO se inventa: en historia el contrapunto es su propia CONFESIÓN a cámara (como se cuenta un secreto), un OBJETO (el espejo, el teléfono, la foto) o la propia cámara. Medido TRES veces: la vecina para la que come insectos, el novio para la que se vuelve víbora — testigos inventados que la premisa nunca pidió y que roban la mitad del video al sujeto. Antes de agregar a alguien, la respuesta por defecto es NO.
