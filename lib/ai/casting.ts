...
- ATRACTIVO NO ES GENÉRICO. Que sean guapos no significa que sean intercambiables: cada uno lleva UN rasgo propio que lo hace inolvidable —un lunar junto a la boca, una cicatriz fina en la ceja, un mechón blanco, los ojos de distinto color, una mirada torcida— y ese detalle convive con la belleza en vez de reemplazarla. Los personajes SECUNDARIOS —el testigo, la madre, el jefe, el amigo— sí son gente común y ahí van los cuerpos y rasgos más corrientes de las listas: el contraste con los protagónicos es lo que hace que estos brillen.
