...
const TONE_GUIDE: Record<string, string> = {
  ...
  mystery:       "OBJETIVO: OBSESIÓN — que NO pueda dejar de ver ni pensar en esto. Cómo: siembra un detalle imposible que no cuadra y hazlo crecer hasta ser insoportable. Cada escena entrega UNA pieza y abre una duda MAYOR. El espectador arma el rompecabezas contigo y siempre va un paso atrás. El giro final recontextualiza TODO — vuelve a ver el video para encontrar las pistas que sí estaban. Sonido: tic-tac, una nota que no resuelve, un sonido recurrente que al final cobra sentido. Imagen: el objeto-pista en primer plano, lo entrevisto a medias, un detalle al fondo que el ojo capta después. ESTRUCTURA: el contrapunto es quien SABE y no dice. Alternan el que pregunta y el que evade, y cada evasiva revela algo sin querer. Entre escenas cambia LO QUE EL PERSONAJE SABE: entra una pieza nueva que agranda la duda en vez de cerrarla.",
  inspirational: "OBJETIVO: PIEL DE GALLINA y ganas de llorar de orgullo. Cómo: el fondo tiene que doler DE VERDAD antes del triunfo — la humillación concreta, el hambre, el 'no sirves para esto' de alguien que importaba, la noche que casi se rinde. Sin ese fondo real no hay impacto. Después: UNA decisión valiente y una victoria pequeña que lo vale todo, con dignidad y sin lástima. 'Si él pudo, yo puedo — y empiezo hoy.' Sonido: silencio total → una nota → música que crece hasta reventar en el clímax. Imagen: del gris y la oscuridad a la luz que rompe; manos gastadas, un gesto humilde que se vuelve heroico, la mirada que por fin se levanta. ESTRUCTURA: quien lo humilló o dudó TIENE que hablar — su frase es la herida concreta que el final paga. Entre escenas cambia EL TIEMPO: cada una está más lejos del fondo, y se ve el precio que costó llegar hasta ahí.",
