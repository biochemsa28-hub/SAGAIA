  ...
  "scenes": [
    {
      ...
      "is_peak": "true SOLO en UNA escena de todo el guion: la del pico físico que exige la REGLA #2.8. false en todas las demás. No lo pongas en la escena 1 (ahí va el gancho) ni en la última (ahí va el cliffhanger): va donde el cuerpo hace lo más grande que hace en toda la historia. Esta marca decide si el sistema dibuja el cuadro con la acción YA OCURRIDA — sin ella, esa acción sale como amago.",
