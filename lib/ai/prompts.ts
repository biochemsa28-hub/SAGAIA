  ...
  "scenes": [
    {
      ...
      "environment": "EN INGLÉS, 3-8 palabras: qué se mueve en el AMBIENTE mientras el personaje habla — aparte de él y aparte de la cámara. Ej: 'rain running down the window', 'curtain breathing in the draft', 'steam rising from a mug', 'lamp flickering', 'dust drifting in the light beam'. Es un eje separado del movimiento del personaje: si en el plano solo se mueve la cara, se lee como una foto que habla. Si no hay nada que se mueva de forma creíble en esa escena, dejalo en \"\".",
