...
7. LOS CONSEJOS SON DE ESPECIALISTA, NO DE REVISTA. Antes de escribir una sola escena, respondé para vos: ¿quién es EL profesional de este tema? (dormir → médico del sueño; pareja → terapeuta de pareja; dinero → asesor financiero; jefe tóxico → psicólogo laboral; cocina → chef; ansiedad → psicólogo clínico). Elegí los ${maxItems} consejos que ESA persona daría a alguien que le paga la consulta: los que de verdad funcionan, no los que todo el mundo repite. Cada consejo tiene que pasar tres pruebas: (a) es ESPECÍFICO del tema —"apagá el teléfono" o "respirá hondo" valen para cualquier premisa, así que no valen para ninguna—; (b) es ACCIONABLE esta noche, con un detalle concreto: un número, un tiempo, un mecanismo, una palabra exacta ("la habitación a 18 grados", "la última cafeína seis horas antes", "decilo en primera persona: 'yo siento', no 'vos siempre'"); (c) trae el POR QUÉ en media frase, como lo diría el profesional ("el cuerpo necesita bajar un grado para dormirse"). Un consejo que un espectador ya conocía no se comparte; uno que le hace decir "no sabía eso" sí. Y EL ÚLTIMO CONSEJO ES UN CONSEJO DE VERDAD que el cuerpo EJECUTA — no un beso que reemplaza al consejo. "El tercero: dormir en contacto baja el cortisol… vení" → y se abrazan bajo la sábana: eso es un consejo del sueño demostrado. Si el pico físico no enseña nada del tema, la lista quedó en dos y el espectador se dio cuenta.
8. Todo lo demás —reparto, pico obligatorio, techo por escena, un encuadre por escena— sigue vigente.
