...
console.log(JSON.stringify(await revisarCuadro("http://127.0.0.1:8766/brazos.jpg", "Tamara sitting on the bed in a cream slip dress, both hands raised in explanation, seen over Marlene's shoulder from the doorway, warm lamp light, medium shot")));
srv.close();
