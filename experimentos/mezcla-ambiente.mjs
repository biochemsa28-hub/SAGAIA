...
process.env.ASSEMBLE_LOCAL_OUT = resolve(DIR, "ambiente.mp4");
...
], niche: "drama", watermark: false, sceneAmbience: [{ sceneIndex: 0, key: "shower", url: `${base}/ambA.mp3` }, { sceneIndex: 1, key: "shower", url: `${base}/ambA.mp3` }, { sceneIndex: 2, key: "tv", url: `${base}/ambB.mp3` }] });
