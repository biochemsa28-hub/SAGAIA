...
export interface VeredictoCuadro {
  ok: boolean;
  defecto?: "doble_exposicion" | "figura_extra" | "collage" | "texto" | "otro";
  motivo?: string;
}
...
export async function revisarCuadro(url: string, escena: string): Promise<VeredictoCuadro> {
  ...
  const pregunta =
    ...
    'Respondé SOLO este JSON: {"ok": true|false, "defecto": "doble_exposicion|figura_extra|collage|texto|otro", "motivo": "una frase"}';
