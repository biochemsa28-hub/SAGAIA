...
export async function revisarCuadro(url: string, escena: string): Promise<VeredictoCuadro> {
  ...
  const pregunta =
    ...
    "- texto: letras, palabras o logos legibles — INCLUIDAS las firmas de artista o watermarks PEQUEÑOS en las esquinas o bordes (mirá las cuatro esquinas con atención: un '©nombre.com' chiquito también es defecto; medido: '©BERYIANSAN.COM' se coló en un video publicado).\n" +
