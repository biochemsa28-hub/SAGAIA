...
const NICHE_SIGNATURE: Record<string, string> = {
  terror:
    "terrifying horror cinematography, pitch-black crushed shadows swallowing the EDGES of the frame — but the subject and their face always clearly lit and readable by a hard single key light, darkness lives AROUND the subject never ON them, cold sickly desaturated palette, heavy volumetric fog, harsh single-source low-key lighting, oppressive claustrophobic framing, visceral primal dread, unsettling wrongness, ONLY the people and objects the scene describes — no added figures, silhouettes or creatures, A24 psychological horror film still, subtle film grain — NO lens flare, no horizontal light streaks across the frame",
  horror:
    "terrifying horror cinematography, pitch-black crushed shadows swallowing the EDGES of the frame — but the subject and their face always clearly lit and readable by a hard single key light, darkness lives AROUND the subject never ON them, cold sickly desaturated palette, heavy volumetric fog, harsh single-source low-key lighting, oppressive claustrophobic framing, visceral primal dread, unsettling wrongness, ONLY the people and objects the scene describes — no added figures, silhouettes or creatures, A24 psychological horror film still, subtle film grain — NO lens flare, no horizontal light streaks across the frame",
  romance:
